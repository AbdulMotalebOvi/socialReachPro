...
const InstaFramModal = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <Modal isOpen={isOpen} setIsOpen={setIsOpen} title=''>
            <form onSubmit={handleSubmit(onSubmit)} className='bg-white  '>
                <div className=" w-[280px]   p-4  text-center m-auto   ">
                    <div className='space-y-2'>
                        {/* Render the uploaded images */}
                        <p className='text-center mt -3'>Choose Your Photo</p>
                    ...
                    <button className='bg-[#012B6D] text-center mt-10 text-white font-semibold w-[200px] h-[35px] text-[14px] rounded'>Upload Your Post</button>
