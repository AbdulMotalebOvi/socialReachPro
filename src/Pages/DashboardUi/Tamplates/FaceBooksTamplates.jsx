...
const FaceBooksTamplates = () => {
    ...
    return (
        <section className='mt-5'>
            ...
            <div className='bg-white px-4 py-3 space-y-5 mt-5'>
                <div className="flex gap-3 items-center">
                    <img src={facebook} className=" object-cover" alt="" />
                    <h3 className="text-[25px] font-medium">Facebook Tamplates</h3>
                </div>
...
export default FaceBooksTamplates